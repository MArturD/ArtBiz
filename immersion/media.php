...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <form action="mediaUploads.php?id=<?php echo $user['id'] ?>" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-xl-6">
                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            <div class="form-group">
                                    ...
                                    <img src="upload/<?php echo $user['avatar']; ?>" alt="" class="img-responsive"
                                         width="200">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="example-fileinput" class="form-control-file" name="avatar[]"
                                       multiple value="<?php echo $user["avatar"]; ?>">
                            </div>
