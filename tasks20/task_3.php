                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="progress progress-sm mb-3">
                                <div class="<?php  echo $value["color"] ?>" role="progressbar" style="width: <?php echo $value["width"] ?>%  ;" aria-valuenow="<?php echo $value["width"] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <?php 
                            }
                            ?>
